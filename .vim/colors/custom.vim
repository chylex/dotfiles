" chylex: old version of peachpuff from vim v8.2.4953 with a few changes
...
set background=dark " chylex: light -> dark
hi clear
if exists("syntax_on")
  syntax reset
endif
...
"hi Normal guibg=PeachPuff guifg=Black " chylex: disable default background/foreground colors
